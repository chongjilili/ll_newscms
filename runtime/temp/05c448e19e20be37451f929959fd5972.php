<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\program\phpStudy\WWW\ll_newscms./application/admin\view\collection_index.html";i:1515484749;s:76:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_header.html";i:1515765715;s:74:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_left.html";i:1515861555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div style="padding: 15px;">
            ...
            <script>
                layui.use('table', function(){
                    ...
                    table.render({
                        elem: '#test'
                        ,url:"<?php echo url('collection/Collectionjson'); ?>"
                        ,cols: [[
                            {type:'checkbox', width:'10%'}
                            ,{field:'ll_coid', width:'10%',  title: 'ID', sort: true}
                            ,{field:'ll_username', width:'25%',   title: '用户名'}
                            ,{field:'ll_title', width:'30%',   title: '新闻标题'}
            ...
            <script type="text/html" id="operation">
                ...
                <a class="layui-btn layui-btn-danger delbtn"  onclick=" return confirm('你真的要删除这个评论吗')" href="<?php echo url('collection/delete' ); ?>?ll_coid={{d.ll_coid}} " >删除</a>
            </script>
