    ...
    <ul class="nav nav-tabs nav-stacked" id="myNav">
        ...
        <li <?php if($l == 5): ?> class="active" <?php endif; ?>  ><a href="<?php echo url('member/notice'); ?>">通知</a></li>
			...
			<div class="newslist col-md-6   col-sm-8">
				 <form action="<?php echo url('member/modify'); ?>" method="post">

					 <div class="form-group">
						 <label for="ll_username">用户id</label>
					  ...
					  <div class="form-group">
					    <label for="ll_username">用户名</label>
					    <input type="text" class="form-control" id="ll_username" name="ll_username" value="<?php echo $umsg['ll_username']; ?>"   >

					  </div>
					  <div class="form-group">
					    <label for="ll_typename">身份</label>
					    <input type="text" class="form-control" id="ll_typename" name="ll_typename" value="<?php echo $umsg['ll_typename']; ?>"  disabled>
					  </div>

					    <div class="form-group">
						    <label for="ll_password">新密码</label>
						    <input type="password" class="form-control" id="ll_password" name="ll_password" value="">
						  </div>
						   <div class="form-group">
						    <label for="qpassword">确认密码</label>
						    <input type="password" class="form-control" id="qpassword" name="qpassword" value="">
						  </div>
