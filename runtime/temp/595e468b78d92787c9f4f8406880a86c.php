...
<nav class="navbar navbar-default">
    ...
    <ul class="nav nav-tabs nav-stacked" id="myNav">
        <li class="active"><a href="<?php echo url('member/index'); ?>">个人资料</a></li>
        <li><a href="<?php echo url('member/apply'); ?>">小编申请</a></li>


        <?php if(in_array(($ll_type), explode(',',"1,2"))): ?>
        <li><a href="<?php echo url('member/addnews'); ?>">编写新闻</a></li>
        <li><a href="<?php echo url('member/newslist'); ?>">新闻管理</a></li>
        <?php endif; ?>

        <li><a href="<?php echo url('member/notice'); ?>">通知</a></li>
			...
			<div class="newslist col-md-6   col-sm-8">
				   <form action="<?php echo url('member/doeditnews'); ?>" method="post">



           <div class="form-group">
              <label for="ll_aid">新闻编号</label>
              <input type="text" class="form-control" name="ll_aid" value="<?php echo $nd['ll_aid']; ?>" disabled id="ll_aid">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ll_title" name="ll_title"   value="<?php echo $nd['ll_title']; ?>"  >
            </div>


             <div class="form-group">
                    <label for="ll_title">发布日期</label>
                    <input type="text" disabled class="form-control" id="ll_time" name="ll_time" value="<?php echo date('Y-m-d H:i:s',$nd['ll_time']); ?>"  >
             </div>
              <div class="form-group">
                     <label for="ll_title">浏览数论</label>
                       <input type="text" disabled class="form-control" id="ll_rnum" name="ll_rnum" value="<?php echo $nd['ll_rnum']; ?>"  >
              </div>
            ...
            <div class="form-group">
              <label for="ll_cid">新闻分类</label>
               <select class="form-control" name="ll_cid" id="ll_cid">
                   ...
                   <option value="<?php echo $cat['ll_cid']; ?>" <?php if($cat['ll_cid'] == $nd['ll_cid']): ?> selected  <?php endif; ?> ><?php $__FOR_START_26646__=1;$__FOR_END_26646__=$cat['floor'];for($i=$__FOR_START_26646__;$i < $__FOR_END_26646__;$i+=1){ ?>----<?php } ?><?php echo $cat['ll_catname']; ?></option>
                   <?php endforeach; endif; else: echo "" ;endif; ?>
                       ...
                       <label class="radio-inline">
                           <input type="radio" name="ll_state" id="ll_state1" value="1" <?php if($nd['ll_state'] == 1): ?> checked  <?php endif; ?> > 发布
                       </label>
                       <label class="radio-inline">
                           <input type="radio" name="ll_state" id="ll_state2" value="2" <?php if($nd['ll_state'] == 2): ?> checked  <?php endif; ?>> 不发布
                       </label>
                       </div>
            ...
            <div class="layui-upload">
              ...
              <label for="ll_content">新闻内容</label>
               <textarea name="ll_content" id="ll_content"><?php echo $nd['ll_content']; ?></textarea>
