<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\program\phpStudy\WWW\ll_newscms./application/admin\view\category_detail.html";i:1515580040;s:76:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_header.html";i:1515333936;s:74:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_left.html";i:1515492247;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form layui-form-pane" action="<?php echo url('category/modify'); ?>">
            <div class="layui-form-item">
                <label class="layui-form-label">分类id</label>
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo $catdet['ll_cid']; ?>" name="ll_cid" disabled  class="layui-input">
                    <input type="hidden" value="<?php echo $catdet['ll_cid']; ?>" name="ll_cid"   class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo $catdet['ll_catname']; ?>" name="ll_catname"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="ll_pcid" lay-filter="aihao">
                        ...
                        <option value="<?php echo $cat['ll_cid']; ?>" <?php if($cat['ll_cid'] == $catdet['ll_pcid']): ?> selected="" <?php endif; ?>><?php $__FOR_START_27399__=1;$__FOR_END_27399__=$cat['floor'];for($i=$__FOR_START_27399__;$i < $__FOR_END_27399__;$i+=1){ ?>----<?php } ?><?php echo $cat['ll_catname']; ?></option>
