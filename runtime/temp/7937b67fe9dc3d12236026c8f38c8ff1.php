<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\program\phpStudy\WWW\ll_newscms./application/admin\view\admin_add.html";i:1515420114;s:76:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_header.html";i:1515333936;s:74:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_left.html";i:1515492247;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form layui-form-pane" action="<?php echo url('Admin/doadd'); ?>">


            <div class="layui-form-item">
                <label class="layui-form-label">用户名称</label>
                <div class="layui-input-inline">
                    <input type="text"   name="ll_username"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" name="ll_password" placeholder="请输入密码" autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" name="qpassword" placeholder="再次输入密码" autocomplete="off" class="layui-input">
                    </div>
