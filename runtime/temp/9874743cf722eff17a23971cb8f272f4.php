<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\program\phpStudy\WWW\ll_newscms./application/admin\view\admin_detail.html";i:1515419681;s:76:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_header.html";i:1515333936;s:74:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_left.html";i:1515657748;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form layui-form-pane" action="<?php echo url('Admin/modify'); ?>">
            <div class="layui-form-item">
                <label class="layui-form-label">用户id</label>
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo $user['ll_uid']; ?>" name="ll_uid" disabled  class="layui-input">
                    <input type="hidden" value="<?php echo $user['ll_uid']; ?>" name="ll_uid"   class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo $user['ll_username']; ?>" name="ll_username"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
