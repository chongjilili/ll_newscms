<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\program\phpStudy\WWW\ll_newscms./application/admin\view\news_addnews.html";i:1515575150;s:76:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_header.html";i:1515765715;s:74:"D:\program\phpStudy\WWW\ll_newscms\application\admin\view\public_left.html";i:1515657748;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form layui-form-pane" action="<?php echo url('news/doadd'); ?>" method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">新闻标题</label>
                    <div class="layui-input-block">
                        <input type="text" name="ll_title" value="<?php echo (isset($nd['ll_title']) && ($nd['ll_title'] !== '')?$nd['ll_title']:''); ?>"   placeholder="请输入标题" class="layui-input">
                    </div>
                </div>
               <!-- <div class="layui-form-item">
                    <label class="layui-form-label">新闻编号</label>
                    <div class="layui-input-inline">
                        <input type="text" name="ll_aid" value="<?php echo (isset($nd['ll_aid']) && ($nd['ll_aid'] !== '')?$nd['ll_aid']:''); ?>" disabled class="layui-input">
                        <input type="hidden" name="ll_aid" value="<?php echo (isset($nd['ll_aid']) && ($nd['ll_aid'] !== '')?$nd['ll_aid']:''); ?>"  class="layui-input">
                    </div>
                </div>-->
                ...
                <!--<div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="ll_catname" disabled value="<?php echo (isset($nd['ll_catname']) && ($nd['ll_catname'] !== '')?$nd['ll_catname']:''); ?>"  class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">新闻类型id</label>
                        <div class="layui-input-inline">
                            <input type="text" name="ll_cid"  value="<?php echo (isset($nd['ll_cid']) && ($nd['ll_cid'] !== '')?$nd['ll_cid']:''); ?>" class="layui-input">
                        </div>
                    </div>
                </div>-->
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="ll_cid"  >
                            ...
                            <option value="<?php echo $cat['ll_cid']; ?>" ><?php $__FOR_START_14223__=1;$__FOR_END_14223__=$cat['floor'];for($i=$__FOR_START_14223__;$i < $__FOR_END_14223__;$i+=1){ ?>----<?php } ?><?php echo $cat['ll_catname']; ?></option>
               ...
               <!-- <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="ll_username" disabled value="<?php echo (isset($nd['ll_username']) && ($nd['ll_username'] !== '')?$nd['ll_username']:''); ?>"  class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">发布人id</label>
                        <div class="layui-input-inline">
                            <input type="text" name="ll_uid"  value="<?php echo (isset($nd['ll_uid']) && ($nd['ll_uid'] !== '')?$nd['ll_uid']:''); ?>" class="layui-input">
                        </div>
                    </div>
                </div>-->
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="ll_uid"  >
                            ...
                            <option value="<?php echo $u['ll_uid']; ?>"><?php echo $u['ll_username']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
               ...
               <!-- <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="ll_rnum"  value="<?php echo (isset($nd['ll_rnum']) && ($nd['ll_rnum'] !== '')?$nd['ll_rnum']:''); ?>" class="layui-input">
                        </div>
                    </div>
                ...
                <div class="layui-form-item layui-form-text"  >
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" style="height: 300px;" class="layui-textarea" id="ll_content" name="ll_content"><?php echo (isset($nd['ll_content']) && ($nd['ll_content'] !== '')?$nd['ll_content']:''); ?></textarea>
